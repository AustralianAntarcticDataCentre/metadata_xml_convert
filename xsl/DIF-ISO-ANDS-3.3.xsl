...
<!-- Released on the 5th of June, 2008.  Last updated on the 14th of March, 2014 -->
<!-- Version 3.3 -->
<!-- This version written specifically for ANDS by Dave Connell on the 24th of May, 2012.  It comments out/removes some DIF/ISO fields that are not required by ANDS - publications and IDN Nodes -->
<!-- ====================================================== -->
                          ...
                          <gml:end>
                            <gml:TimeInstant>
                              <xsl:choose>
                                ...
                                <xsl:when test="./dif:Stop_Date=''">
                                  <xsl:attribute name="gml:id">
                                    <xsl:variable name="uid" select="INSERT_RANDOM_UUID_HERE"/>
        ...
        <xsl:choose>
          ...
          <gmd:transferOptions>
            <gmd:MD_DigitalTransferOptions>
              ...
              <!--I have removed the Related URL sections and hard coded in a link to add a URL directly to the original metadata record back on the AMD/AU portal.  The copy in testdata is the official one - this copy has only commented out the related URL sections, which will NOT work properly with the validator.  I've left the Related URl sections in for the moment in case ANDS decide they want them.-->

              <gmd:onLine>
                <gmd:CI_OnlineResource>
                  <gmd:linkage>
                    <gmd:URL>
                      http://data.aad.gov.au/aadc/metadata/metadata_redirect.cfm?md=<xsl:value-of select="dif:Entry_ID"/>
                    </gmd:URL>
                  </gmd:linkage>
                  <gmd:protocol>
                  ...
                  <gmd:description>
                    <gco:CharacterString>
                      View the record in the original DIF format, with all data links
                    </gco:CharacterString>
                  </gmd:description>
                </gmd:CI_OnlineResource>
              </gmd:onLine>
